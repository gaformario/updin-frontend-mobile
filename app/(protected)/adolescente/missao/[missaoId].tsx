    ...
    return (
      <SafeAreaView style={styles.notFoundContainer}>
        ...
        <Text style={styles.notFoundText}>
          Não encontramos os detalhes dessa missão para esse adolescente.
        </Text>
      </SafeAreaView>
    );
  }
      ...
      >
        ...
        >
          <Text style={styles.infoText}>
            {missao.prazo || "Sem prazo definido - Complete quando puder!"}
          </Text>
        </InfoCard>
        ...
        >
          ...
          <Text style={styles.tipText}>
            {missao.dica ||
              "Quanto melhor voce documentar a conclusão da missão, mais rápida sera a aprovação!"}
          </Text>
        </LinearGradient>
        ...
        <TouchableOpacity
          ...
          onPress={() =>
            router.push(`/(protected)/adolescente/missao/${missao.id}/concluir` as any)
          }
        >
